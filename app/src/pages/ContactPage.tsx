...
const FAQ = [
  ...
  { q: 'Сколько заданий можно решать бесплатно?', a: 'Бесплатный план включает 20 заданий в день. Лимит сбрасывается каждый день в полночь. Premium-подписка снимает ограничения.' },
